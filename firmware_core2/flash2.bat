@echo off
REM ============================================
REM Wrapper para flash_core2.py - no cierra la ventana
REM ============================================
cd /d "%~dp0"
...
echo.
echo   Lanzando: flash_core2.py --wifi IOT IOT_Enlaces_205
echo.

python flash_core2.py --wifi IOT IOT_Enlaces_205
